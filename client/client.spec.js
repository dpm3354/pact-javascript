...
const mocks = require('./expectation/mocks')
...
describe('product handling', () => {
  ...
  describe('#getAllProducts', () => {
    it('should get product list from server', async function () {
      await provider.addInteraction(mocks.getProductList)
  ...
  describe('#getProducts', () => {
    it('should return product list based on query', async function () {
      await provider.addInteraction(mocks.getFilteredProductList)
  ...
  describe('#registerProduct', () => {
    it('should send product registration request', async function () {
      await provider.addInteraction(mocks.registerProduct)
